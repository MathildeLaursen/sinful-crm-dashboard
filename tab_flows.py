...
def render_overview_content(flow_df, sel_countries, sel_flows, full_df=None, all_months_df=None, ignore_inactive=True, active_flows=None):
    ...
    if ignore_inactive and active_flows is not None:
        chart_source_df = chart_source_df[chart_source_df['Flow_Trigger'].isin(active_flows)]
    ...
    if ignore_inactive and active_flows is not None:
        # Vis kun aktive flows i tabellen
        table_df = table_df[table_df['Flow_Trigger'].isin(active_flows)]
...
def render_overview_tab_content(df, available_months):
    ...
    ignore_inactive = st.session_state.fl_ignore_inactive_overview
    render_overview_content(flow_df, sel_countries, sel_flows, full_flow_df, all_months_flow_df, ignore_inactive, active_flows)
